...
$(document).ready(function () {
	...
	$(window).on("scroll", function () {
		if ($(this).scrollTop() > 220) {
			// $(".logo").find("img").attr("src", "assets/img/logo/logo.png");

			// if (localStorage.getItem("theme") == "dark-theme") {
			// 	$("#ligth__logo").attr("hidden", "hidden");
			// 	$("#dark__logo").removeAttr("hidden");
			// } else {
			// 	$("#ligth__logo").removeAttr("hidden");
			// 	$("#dark__logo").attr("hidden", "hidden");
			// }
	...
	function setTheme(theme) {
		if (theme == "dark-theme") {
			...
			// if ($(window).scrollTop() > 220 && localStorage.getItem("theme") == "dark-theme") {
			// 	console.log("theme dark and scroll top 220+");
			// 	$("#dark__logo").attr("hidden", "hidden");
			// 	$("#ligth__logo").removeAttr("hidden");
			// } else {
			// 	console.log("theme light and scroll top 220+");
			// }
		}
	}
	//Dark Light Template Area//
